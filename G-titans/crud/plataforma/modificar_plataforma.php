...
<body>
      <?php
       ...
       $sql=mysqli_query($con,"SELECT * FROM plataforma WHERE id_plataforma='$id_plataforma'");
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
         <form method="post" action="modificar_plataforma_validar.php">
                 <div class="row mt-4">
                   <div class="col-12 mb-4">
                        <label for="">Nombre plataforma</label>
                        <input type="text" name="nombre_pla" class="form-control" value="<?php echo $f2['nombre_pla'];?>" required  id=""><br>
                   </div>
                 </div>
                 <input type="hidden" name="id_plataforma" value="<?php echo $id_plataforma?>">

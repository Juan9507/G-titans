...
<head>
  ...
  <title>Administrador categoria</title>
        ...
        <div id="page-content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <?php
              ...
              $sql=mysqli_query($con,"SELECT * FROM categoria  WHERE estado_categoria=1");
            ?>
            <div class="row">
              <div class="col">
                <a href="#" class="btn btn-secondary btn-lg mb-4" data-toggle="modal" data-target="#Modal">Registrar categoria</a>
              </div>
              <div class="col mb-4">
              </div>
            </div>
            ...
            <div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../crud/categoria/guardar_categoria.php" method="post">
                      <div class="row">
                        <div class="col">
                            <label for="">Digite el nombre de la categoria ejemplo terror, aventura:</label>
                            <input type="text" class="form-control" style="text-transform:lowercase;" name="nombre" required id="">
                        </div>
                      </div>
                        </div>
              ...
              <table class="table table-bordered" id="example">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <?php echo $row['id_juego'];?>
                    </td>
                    <td>
                      <?php echo $row['nombre_ca'];?>
                    </td>
                    <td>
                      <?php echo $row['estado_categoria'];?></a>
                    </td>
                    <td>
                      <a href="../crud/categoria/modificar_categoria.php?id_juego=<?php echo $row['id_juego'];?>"><i class="fas fa-user-edit"></i></a>
                    </td>
                    <td>
                      <a href="../crud/categoria/eliminar_categoria.php?id_juego=<?php echo $row['id_juego'];?>"><i class="fas fa-backspace"></i></a>
                    </td>
                  </tr>
                    <?php
                    }
